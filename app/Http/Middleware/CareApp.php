...
class CareApp
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if(
            ...
            $refererHost != 'connect.stripe.com' &&
        ...
        if(getenv('APP_ENV') == 'local'){
            Session::put('platformUrl', 'http://localhost:8081') ;
        }else{
            Session::put('platformUrl', 'https://app.camping.care') ;
        }
        ...
        $request->session()->put('installed', $installed);
