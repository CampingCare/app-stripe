    ...
    <body>
        ...
        <div>
            ...
            @isset ($stripeTokens)
                ...
                <p class="py-2 mt-4">
                    <a href="?action=disconnect" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">{{ __('Disconnect Stripe') }}</a>
                </p>
            ...
            @else
                ...
                <div class="text-center py-8 mt-8">
                    ...
                    <p class="py-4 max-w-md mx-auto">{{ __('By connecting your Stripe account you can receive direct payments in to your bankaccount. Clients can pay via Creditcard, IDeal, Sofort, Mistercash or Paypal.') }}</p>

                    <p class="py-4">
                        <a href="https://connect.stripe.com/oauth/authorize?response_type=code&client_id={{ $clientId  }}&scope=read_write" target="_parent" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
